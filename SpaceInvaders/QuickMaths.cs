...
namespace View
{
    class QuickMaths
    {
        ...
        public QuickMaths(MainWindow main)
        {
            ...
            this.PlayerHeight = main.playground.Height / 100 * 13;
            this.PlayerWidth = main.playground.Height / 100 * 17;
            this.AlienHeight = main.playground.Height / 100 * 2;
            this.AlienWidth = main.playground.Height / 100 * 2;
            this.ShotHeight = main.playground.Height / 100 * 2;
            this.ShotWidth = main.playground.Height / 100 * 2;
        }
